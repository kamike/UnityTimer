...
Alternatively, if you like to live on the bleeding edge, add `https://github.com/kamike/UnityTimer.git` to your packages in Unity Package Manager. However, we do not guarantee this will give you a stable version.
